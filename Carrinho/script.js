...
function carrinhoVazio(){
    ...
    if (items === null) {
        ...
        carrinhoExibir.innerHTML = `
        <div class="noProduct">
            <div class="small-title">Seu carrinho do Restaurant_2 está vazio</div>
...
function mensagem(){
    ...
    var mensagemWhats = 'https://api.whatsapp.com/send?l=pt_BR&phone=5512991750528&text=Boa%20noite%20pessoal,%20gostaria%20de%20pedir:';
